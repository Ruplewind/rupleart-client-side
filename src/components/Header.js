...
function Header() {
  return (
    <div className='flex items-center justify-between shadow-md rounded-b-sm shadow-slate-400 w-full p-3 font-montserrat'>
        ...
        <div className='flex items-center justify-end'>
            <ul className='collapse lg:visible uppercase mr-1 lg:mr-10 tracking-wider text-sm'>
                <div className='flex justify-end gap-2'>
                    ...
                    <Link to={"/"} className='bg-purple-900 hover:bg-purple-900 text-white rounded-lg text-xs flex px-2 items-center'>Post Ad</Link>
                </div>
            </ul>
