                        ...
                        <tr className='mt-5 border-b border-gray-300 p-4'>
                            ...
                            <td className='text-center p-2'>{
                                ad.delivery_status == "pending" ? 
                                    <div className='bg-gray-300 text-xs rounded-2xl p-1 w-full lg:w-3/4 mx-auto'>Pending Confirmation</div>
                                :
                                ad.delivery_status == "transit" ? 
                                    <div className='bg-orange-900 text-white text-xs rounded-2xl p-1 w-full lg:w-3/4 mx-auto'>In Transit</div>
                                :
